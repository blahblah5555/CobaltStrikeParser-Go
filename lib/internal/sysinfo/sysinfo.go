...
import (
	...
	internalcpu "github.com/blahblah5555/CobaltStrikeParser-Go/lib/internal/cpu"
)
...
func (cpu *cpuInfo) Name() string {
	cpu.once.Do(func() {
		// Try to get the information from github.com/blahblah5555/CobaltStrikeParser-Go/lib/internal/cpu.
